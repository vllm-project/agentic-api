...
#[openapi(
    ...
    paths(
        ...
        crate::handler::http::file_search::update_vector_store,
        crate::handler::http::file_search::update_vector_store_file,
        crate::handler::http::file_search::vector_store_file_content,
