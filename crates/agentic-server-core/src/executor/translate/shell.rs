//! Public shell lifecycle translation for client-executed canonical function calls.

use super::custom::{complete_json_string_prefix, custom_frame};
...
#[cfg(test)]
mod tests {
    use super::super::MAX_PENDING_FUNCTION_BYTES;
    use super::*;
    #[test]
