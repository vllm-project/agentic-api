...
Interactions should compose the same API-agnostic execution primitives used by
Responses and Messages, adding workflow structure without duplicating the
underlying model-call and tool-call loop.
