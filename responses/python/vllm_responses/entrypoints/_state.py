...
def require_vr_app_state(app: FastAPI) -> VRAppState:
    ...
    if app_state is None:
        raise RuntimeError("vllm_responses app state is not initialized.")
    return app_state
